...
<div class="page-header" style="padding:10px 20px;margin:-18px 0px 0px">
  <div id="searchForm">
    ...
    <div class="col-md-3" style="text-align: left;padding-bottom: unset">
        <button id="addBtn" class="btn btn-labeled btn-primary" onclick="javascript:showModal('定义Topic类', 'admin/product/addProductPage');"><span class="btn-label icon fa fa-plus"></span>定义Topic类</button>
    </div>
  </div>
</div>
